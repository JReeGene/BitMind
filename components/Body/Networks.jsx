...
const Networks = (
  ...
  //CALLING HOOK
  useEffect(()=>{
    const networksLists = JSON.parse(localStorage.
      getItem('setNetworks'));
...
return (
  <div className='bitmind_fn_content'>
    <div className='bitmind_fn_page'>
      <div className='bitmind_fn_models_page'>
                  ...
                  <ul className='fn__model_items'>                   
                    {
                      networks?.map((network, index)=>(
                        ...
                        >
                          ...
                          >
                            <div className='img'>
                              <img src={network?.image || 'img/light-logo.png'} alt="" />                              
                            </div>
                            <div className='item__info'>
                              <h3 className='title'>{network?.networkName}</h3>
                              <p 
                                className='desc'>
                                  Your wallet seed-phrase is private to you, address and
                                <span 
                                  onClick={()=>
                            ...
                            <div 
                              ...
                              <img 
                                src={userDetails?.image || 'img/light-logo.png'} 
                                alt="" />
                              <h3 
                                ...
                                {/* <span>{network?.walletAddress}</span> */}
                                <FaRegCopy/>
                              </h3>                             
                            </div>
                          </div>
