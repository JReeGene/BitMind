                      ...
                      <div className='fn_contact_form'>
                        ...
                        <div className='input_list'>
                          <ul>
                            ...
                            <li>
                              <input type="text" placeholder='Token Address 1'
                            ...
                            <li>
                              <input type="text" placeholder='Token Address 2'
                            ...
                            <li>
                              <textarea type="text" placeholder='Buy Amount'
                              onChange={(e)=>handleFormFieldChange('buyAmount', e)} />
                            </li>
                            <li>
                              <textarea type="text" placeholder='Target Price'
